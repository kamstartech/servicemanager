      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href={`/mobile-banking/users/${userId}`}>
        ...
        <Button asChild>
          <Link href={`/mobile-banking/users/${userId}/beneficiaries/new`}>
                    ...
                    <tr key={beneficiary.id} className="border-b hover:bg-muted/50">
                      ...
                      <td className="p-3">
                        <div className="flex gap-2">
                          ...
                          >
                            <Link
                              href={`/mobile-banking/users/${userId}/beneficiaries/${beneficiary.id}/edit`}
                            >
