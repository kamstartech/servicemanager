...
function resolveAuthHeaders(auth: AuthConfig): Record<string, string> {
    ...
    const apiKey = process.env.ESB_APIKEY || process.env.ESB_API_KEY || "";
...
/**
 * ESB Client for Biller Operations
 * Similar to ESBAirtimeTopupService but for billers
 */
export class ESBBillerClient {
